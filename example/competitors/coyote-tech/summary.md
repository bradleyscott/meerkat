---
company: Coyote Tech
website: https://www.coyotetech.example.com
blog_url: https://www.coyotetech.example.com/blog
linkedin: https://www.linkedin.com/company/coyote-tech
...
|---------|-------------|----------------|
| HuntDrone Pro | Autonomous pursuit drone with AI-powered prey tracking | Enterprise predators |
| HuntDrone Lite | Simplified consumer drone for casual hunting | Individual operators |
| FlockOS | Cloud platform for managing drone fleets and coordinating multi-drone hunts | Large operations |
| Prey Vision API | Computer vision API for prey identification and trajectory prediction | Developer ecosystem |
